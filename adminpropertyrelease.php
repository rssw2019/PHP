...
<div class="card">
    ...
    // collecting data from the user
        $publishedvalue =  htmlspecialchars($_POST['published']);
        $admin_id =  htmlspecialchars($_POST['id']);

        $sql = "UPDATE prop_listing_tble SET published='$publishedvalue' WHERE id=$admin_id";
          
        if(mysqli_query($conn, $sql)){
            echo "Published status of the property with ID = ". $admin_id. " has been changed into ".$publishedvalue."."; 
        } else{
        ...
        //echo $row_cnt_unpublished;
        if($row_cnt_unpublished>0){        
            echo "<p> Back to <a href=\"adminunpublishedproperty.php\">unpublished properties.</a></p>";
        }
        else{
            echo "<p> Back to <a href=\"adminmanageproperty.php\">manage properties.</a></p>";
        }
        ?>
        <?php
    ...
    <p> 
        <a href="adminmanageproperties.php">Back to Manage Property </a> 
    </p>
