...
<div class="container-fluid mt-4">
    <h5> Search Result by Property Type</h5>

    <!--Displaying Filered Results --->
    <?php
        if(isset($_POST['submit'])){
            $rowCount=0;
            $user_prop_type= trim($_POST['proptype']);
            //echo $user_prop_type;
            if (isset($user_prop_type)) {
                $q ="select * FROM prop_listing_tble WHERE status='1' AND proptype = '$user_prop_type' ORDER BY date DESC";
                        ...
                        <div class ="card-body">
                            <p class ="card-body-text">
                                <div class="row">
                                    ...
                                    <div class ="col">
                                        <div class="input-group">
                                            <b>Property Address </b> <?php echo $rows['district']; ?> district, <?php echo $rows['vdc']; ?> Municipality/VDC, Ward number <?php echo $rows['ward'];?> <br>
    ...
    <?php
                    ...
                    echo "<p> There are no records with your criteria.</p>";
                }
