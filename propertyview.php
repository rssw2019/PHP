...
<body style="background-color:cream;">
    ...
    <div class="container">
        <a class="text-decoration-none" href="https://www-purnimonline-com.translate.goog/realty/index.php?_x_tr_sl=auto&_x_tr_tl=ne&_x_tr_hl=en-US&_x_tr_pto=wapp" style="color:red;"> नेपाली भाषामा </a>
    </div>
           ...
           <div class="col-sm-12 col-md-4">
               <div class="card">
                  <div class="card-body">
                      <h5> Job Opening !</h5>
                      <p class="card-text">
                          Do you need a flexible job with a nice pay? We are currently looking for real estate agents for all major cities of Nepal. If you are interested, please apply by clicking on the following link. We will provide you trainings required for this job. 
                          <p>
                                <a href="jobapplication.php">Apply For This Job</a>
                                </p>
                      </p>
                      <p class="card-text">
                          <h5>जागिरको अवसर !</h5>
                            के तपाईलाई राम्रो तलबको साथ लचिलो काम चाहिन्छ? हामी हाल नेपालका सबै प्रमुख शहरहरूको लागि घर जग्गा एजेन्टहरू खोजिरहेका छौं। यदि तपाइँ इच्छुक हुनुहुन्छ भने, कृपया निम्न लिङ्कमा क्लिक गरेर आवेदन दिनुहोस्। हामी तपाईंलाई यो कामको लागि आवश्यक तालिमहरू प्रदान गर्नेछौं।

                      <br><p><a href="jobapplication.php">यो कामको लागि आवेदन दिनुहोस्।</a>
                      </p></p>
                  </div>
              </div> 
           </div>
