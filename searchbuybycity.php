...
<!-- Search by city form begins -->
    ...
    <h5> Search Properties for Sale by City </h5>
    
    <form action="searchbuybycityresultview.php" method="GET">  
    <p> Please select your property type (house or land) below. </p> 
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-primary" name = "searchbuybycitysubmit"> Submit </button>
    </form>
