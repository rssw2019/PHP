...
<div class="container-fluid mt-4">
    <h5> Search Result by Sales Type </h5>

    <!--Displaying Filtered Results --->
    <?php
        if(isset($_POST['submit'])){
            $rowCount=0;
            $user_sell_type=trim($_POST['selltype']);
            //echo $user_value;
            //echo "hi";

            if (isset($user_sell_type)) {
                ...
                //$q ="select * from prop_listing_tble WHERE district='$user_district' ORDER BY date DESC";  
                //$q ="select * from prop_listing_tble WHERE prop_type= '$user_prop_type' ORDER BY date DESC";                    
                $q ="select * from prop_listing_tble WHERE status='1' AND selltype='$user_sell_type' ORDER BY date DESC";
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <?php echo $rows['prop_type']; ?>  for <?php echo $rows['sell_type']; ?><br>
