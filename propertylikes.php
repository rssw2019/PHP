...
<body>
    ...
    // collecting data from the user
        ...
        while($rows = mysqli_fetch_array($query))
        {
            ...
            $likednumber=$rows['likednumber']+1;
            ?>
            <div class ="row">
            ...
            <!--Property details question ends        -->
                ...
                <?php
                    ...
                    $sql_likednumber = "UPDATE prop_listing_tble SET likednumber='$likednumber' WHERE id=$id";
                
                    if(!mysqli_query($conn, $sql_likednumber)){
