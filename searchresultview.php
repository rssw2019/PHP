...
//sql querry to get data from the mysql database
    $prop_querry="select status, date, id, selltype, proptype, name, email, phone1, phone2, district, city, area, unit, price, visitnumber, likednumber from prop_listing_tble where price > '$minprice' and price < '$maxprice' and district='$district' and proptype='$proptype' and selltype='$selltype'";
