...
<html lang="en">
<head>
  <title>Agent Property Notes</title>
  <meta charset="utf-8">
...
<div class="card">
    ...
    // collecting data from the user
        $agentnotes_value =  $_POST['agentnotes'];
        $agent_id =  htmlspecialchars($_POST['id']);
        $agentnotes_value=$agentnotes_value." Submitted by: ".$user;

        $sql = "UPDATE prop_listing_tble SET agentnotes='$agentnotes_value' WHERE id=$agent_id";
          
        if(mysqli_query($conn, $sql)){
            echo "Verification status of the property with ID = ". $agent_id. " has been changed into ".$agentnotes_value."."; 
        } else{
    ...
    <p> 
        <a href="agentmanageproperty.php">Back to Manage Property </a> 
    </p>
