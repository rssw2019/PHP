...
<?php
   //Get data from top menu
    if(isset($_GET['databasecol'])){
        ...
        $searchtitle="Properties for ". $filterby;
    }
//echo $filter;
?>
<?php 
    ...
    if(isset($_GET['databasecol1'])){
        ...
        $searchtitle=$filterby2." for ". $filterby1;
    }
//echo $filter;
?>
...
<?php 
    ...
    if(isset($_GET['citysearchsubmit'])){
        ...
        $filterby=$_GET['city'];
        $filter="where ".$databasecol." = "."'$filterby'";
        $searchtitle="Properties in ".$_GET['city'];
    }
...
<div class="row">
    <div class="container">
        <div class="w-auto p-2" style="background-color:white;">    
    <p>
        Hello <b><?php echo $user; ?></b>,<br> Welcome to your account page in Purnim Realty. Submit your new property listing information <a href="listyourpropertiesform.php"> here </a>. If you need to make changes in your existing listings, please email your information to contactus@purnimonline.com or submit your new information <a href="contact.php"> here</a>. Below is the list of properties submitted by you.
