    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            if (isset($user_minprice)) {
                $q ="select * from prop_listing_tble WHERE status='1' AND price > $user_minprice AND price < $user_maxprice AND district='$user_district' AND proptype= '$user_proptype' AND selltype= 'rent' ORDER BY date DESC";
