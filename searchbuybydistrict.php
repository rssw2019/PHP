...
<!-- Search by city form begins -->
    ...
    <h5> Search Property For Sale by District </h5>
    

    <form action="searchbuybydistrictresultview.php" method="GET">
        <p> Please select your sale type (house or land ) below. </p> 
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-primary" name = "searchbuybydisctrictsubmit"> Submit </button>
    </form>
