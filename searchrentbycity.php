...
<!-- Search by city form begins -->
    ...
    <h5> Search Rental Propertis by a Major City </h5>

    <form action="searchrentbycityresultview.php" method="GET">
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-primary" name = "searchrentbycitysubmit"> Submit </button>
    </form>
